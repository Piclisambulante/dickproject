...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (storedLoginStatus === 'true') {
    ...
    document.getElementById('userAvatar').src = user.profilePicture || 'img/user icon.png';
  ...
  formLogin.addEventListener('submit', function (e) {
    ...
    if (user && user.email === email && user.password === password) {
      ...
      userAvatar.src = user.profilePicture || 'img/user icon.png';
  ...
  confirmLogoutBtn.addEventListener('click', function () {
    ...
    userName.innerText = '';
    userEmail.innerText = '';
    userAvatar.src = 'img/user icon.png';
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  editProfileBtn.addEventListener('click', function () {
    // Preenche os campos com as informações atuais do usuário
    const storedUser = localStorage.getItem('user');
    const user = JSON.parse(storedUser);
    ...
    editProfileModal.classList.add('show'); // Abre o modal
  });

  // Função para fechar o modal de editar perfil
  closeEditProfileModal.addEventListener('click', function () {
    editProfileModal.classList.remove('show'); // Fecha o modal
  });

  // Salvar as alterações no perfil
  saveProfileBtn.addEventListener('click', function (e) {
    e.preventDefault(); // Impede o comportamento padrão do botão de envio do formulário
    ...
    const updatedUser = { name, email, password, profilePicture: '' };
